...
web             IN      A       51.178.41.9 ; VPS - TIMOTHY
...
$INCLUDE /etc/bind/Kwt7.ephec-ti.be.+008+34099.key
$INCLUDE /etc/bind/Kwt7.ephec-ti.be.+008+59979.key
$INCLUDE /etc/bind/zones/db.wt7.ephec-ti.be.signed
